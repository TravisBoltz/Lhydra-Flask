...
data_paths = [paths["test_data"], paths["processed_data"] / "test_data.csv"]

encoder_paths = [paths["encoder"], paths["processed_data"] / "encoder.pt"]
        ...
        return jsonify(
            {
                ...
                "api_version": "1.0.0",
                "supported_genres": (
                    list(recommender.encoders.known_genres)
                    if hasattr(recommender, "encoders")
                    else []
                ),
            }
        )
